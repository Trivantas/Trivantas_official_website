...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (form.current) {
      emailjs
        .sendForm(
          'service_wc4fr1k',   // replace with your EmailJS service ID
          'template_zty9wpq',  // replace with your EmailJS template ID
          form.current,
          'gKoMfAEQG-eJ8YLvY'    // replace with your EmailJS public key
        )
        .then(
          () => {
